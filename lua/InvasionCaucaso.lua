...
function MissionTruco()
    ...
    trigger.action.explosion(StaticObject.getByName("OBJ2 ABASTECIMIENTO4"):getPosition().p, 3000)
    trigger.action.explosion(StaticObject.getByName("OBJ2 ABASTECIMIENTO3"):getPosition().p, 3000)
    trigger.action.explosion(StaticObject.getByName("OBJ2 ABASTECIMIENTO2"):getPosition().p, 3000)
    trigger.action.explosion(StaticObject.getByName("OBJ2 ABASTECIMIENTO1"):getPosition().p, 3000)
    trigger.action.explosion(StaticObject.getByName("OBJ2 ABASTECIMIENTO4"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #138"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #144"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #140"):getPosition().p, 3000)
 --[[   trigger.action.explosion(Unit.getByName("Unit #136"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #135"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #134"):getPosition().p, 3000)
     trigger.action.explosion(Unit.getByName("Unit #137"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #136"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #130"):getPosition().p, 3000)
 ]]    trigger.action.explosion(Unit.getByName("Unit #125"):getPosition().p, 3000)
--[[     trigger.action.explosion(Unit.getByName("Unit #122"):getPosition().p, 3000)
    trigger.action.explosion(Unit.getByName("Unit #128"):getPosition().p, 3000)
 ]]    trigger.action.explosion(Unit.getByName("CARRI RUSSI #001"):getPosition().p, 3000)
